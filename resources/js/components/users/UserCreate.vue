	                ...
	                <div class="card-body">
	                    <form>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-7">
	                                <select class="form-control" v-model="user.house">
	                                    <option></option>
                            ...
                            <div class="col-7">
                                <span class="mr-5"><input type="radio" v-model="user.admin" value="1">Yes</span>
                                <input type="radio" v-model="user.admin" value="0">No
